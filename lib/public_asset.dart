...
List<Dzikir> dzikirPagi = [
  ...
  Dzikir(
      "Sayyidul Istighfar",
      "اَللَّهُمَّ أَنْتَ رَبِّيْ لاَ إِلَـهَ إِلاَّ أَنْتَ، خَلَقْتَنِيْ وَأَنَا عَبْدُكَ، وَأَنَا عَلَى عَهْدِكَ وَوَعْدِكَ مَا اسْتَطَعْتُ، أَعُوْذُ بِكَ مِنْ شَرِّ مَا صَنَعْتُ، أَبُوْءُ لَكَ بِنِعْمَتِكَ عَلَيَّ، وَأَبُوْءُ بِذَنْبِيْ فَاغْفِرْ لِيْ فَإِنَّهُ لاَ يَغْفِرُ الذُّنُوْبَ إِلاَّ أَنْت",
  ...
  Dzikir(
      ...
      "اللَّهُمَّ عَافِـنِـي فِـي بَدَنِــيِ، اللَّهُمَّ عَافِــنِـي فِـي سَـمْعِي، اللَّهُمَّ عَافِــنِـي فِـي بَصَرِي، لاَ إِلَهَ إِلاَّ أَنْتَ، اللَّهُمَّ إِنِّـي أَعُوذُ بِكَ مِنَ الكُفْرِ وَالْفَقْرِ، وَأَعُوذُ بِكَ مِنْ عَذَابِ الْقَبْـرِ، لاَ إِلَـهَ إِلاَّ أَنْتَ",
      "Allahumma \'Afini Fii Badanii, Allahumma \'Afinii Fii Sam\'ii, Allahumma \'Afinii Fii Bashrii, Laa ilaha Illa Anta, Allamumma inii A\'uzubika Minal Kufri Wal Faqrii, Wa A\'uzubika min \'Azaabil Qabri, Laa Ilaha Illa Anta \n\nArtinya : Ya Allah! Selamatkan tubuhku, Ya Allah, selamatkan pendengaranku, Ya Allah, selamatkan penglihatanku (dari segala cacat dan penyakit). Tiada Tuhan yang berhak disembah melainkan Engkau, Ya Allah aku berlindung kepada-Mu dari Kekufuran dan Kefakiran, dan aku berlindung kepada-Mu dari Azab Kubur, Tiada Tuhan yang berhak Disembah kecuali Engkau. [Dibaca 3x]"),
  Dzikir(
      "",
